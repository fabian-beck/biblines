var bib = {
    ...
    "Beck2012Rapid": {
        ...
        "keywords": "paradigm:node-link, mental\\_map, application:social, application:software\\_engineering, type:technique, compound_graph, directed_graph, weighted_graph, bipartite, evaluation:case\\_study, time:timeline, time:animation, animated_timeline, time_aggregation, program_execution",
        "pages": "185--192",
        "publisher": "IEEE",
    ...
    "Beck2016Taxonomy": {
        ...
        "author": "Beck, Fabian and Burch, Michael and Diehl, Stephan and Weiskopf, Daniel",
        "comment": "to appear; extended version of Beck2014State",
        "doi": "10.1111/cgf.12791",
        "journal": "Computer Graphics Forum",
        "keywords": "type:evaluation, time:generic, paradigm:generic, evaluation:survey, application:generic",
        "references": "Archambault2014Temporal Alencar2012TimeAware Ahmed2010Visual Abello2013Modular Archambault2012Mental Archambault2013Map Archambault2013Mental Archambault2014Application Archambault2015Animation Archambault2011Animation Archambault2011Difference Ahn2013Task Ahn2011Temporal Beck2013Matching Boyandin2012Qualitative Boitmanis2008Visualizing Burch2014Dynamic Beck2012Rapid Burch2012Radial Brandes2003Visual Burch2008TimeRadarTrees Bach2014Review Burch2010TimeSpiderTrees Brasch2012VENLO Brandes2006Dynamic Beyer2006Animated Brandes2006Affiliation Bach2015Small Burch2011Layered Brandes2012Visualization Brandes2012Quantitative Burch2012Visualizing Burch2015Edge-Stacked Brandes2011Asymmetric Bach2014GraphDiaries Branke2001Dynamic Burch2013MatrixBased Burch2011Parallel Brandes1997Bayesian Burch2015FlipBook Cohen1992Framework Cohen1995Dynamic Chen2006CiteSpace Collberg2003System Cengiz2013Visualization Dwyer2002Visualising Diehl2002Graphs Diehl2001Preserving Erten2004Exploring Erten2004GraphAEL Erten2004Simultaneous Elmqvist2003Causality Federico2011Visual Friedrich2001Marey Friedrich2002Graph Friedrich2002GraphII Farrugia2011Exploring Forrester2005graphael Frishman2004Dynamic Frishman2008MOVIS Frishman2008Online Feng2012Coherent Grabowicz2014Fast Greilich2009Visualizing Gorg2005Dynamic Gorochowski2012Using Ghani2012Perception Gansner2013Interactive Greevy2006Visualizing Gaertler2006Hybrid Hlawatsch2014Visual Hurter2013Bundled Huang1998Online Hu2012Embedding Hayashi2013Initial Hadlak2011Situ Hadlak2015Survey Itoh2012Visualization Itoh2010Interactive John2011Constructing Kumar2006Visual Kerracher2014Design Kerracher2015Task Kerracher2015Visual Kimelman1995Reduction Loubier2008Temporal Lee2006Mental Li2013Visual Lin2010ContexTour Liao2013Visual Misue1995Layout Mashima2012Visualizing Moody2005Dynamic Nesbitt2002Applying North1996Incremental Oelke2013Fingerprint Ogawa2008StarGate Ogawa2009codeswarm Pohl2008Interactive Purchase2007Important Purchase2008Extremes Rey2010Controlling Rufiange2013DiffAni Reitz2009Focused Rohrschneider2010Visual Schmauder2015Visualizing Smuc2014Connect Saraiya2005Visualization Sallaberry2012Clustering Stab2010SemaTime Saffrey2008Mental Stein2010PixelOriented Shi2015Egocentric Toyoda2005System Trier2006Towards Vehlow2013Radial Vehlow2015State vandenElzen2013Dynamic Vehlow2013iVUN vonLandesberger2013Visual Windhager2011Visual Yang2008Visual Yi2010TimeMatrix Zaman2011Effect Vehlow2015Visualizing",
        "series": "CGF",
    ...
    "Branke2001Dynamic": {
        "abstr": "Many graph drawing (GD) scenarios are dynamic inasmuch as they involve a repeated redrawing of the graph after frequently occurring changes to the graph structure and/or some layout properties.",
    ...
    "Forrester2005graphael": {
        "abstr": "The graphael system implements several traditional force-directed layout methods, as well as several novel layout methods for non-Euclidean geometries, including hyperbolic and spherical. The system can handle large graphs, using multi-scale variations of the force-directed methods. Moreover, graphael can layout and visualize graphs that evolve though time, using static views, animation, and morphing. The implementation includes a powerful interface that allows the user to put together existing algorithms and visualization techniques, and to easily add new ones. The system is written in Java and is available as a downloadable program or as an applet at http://graphael.cs.arizona.edu.",
    ...
    "Gorg2005Dynamic": {
        "abstr": "In this paper we introduce two novel algorithms for drawing sequences of orthogonal and hierarchical graphs while preserving the mental map. Both algorithms can be parameterized to trade layout quality for dynamic stability. In particular, we had to develop new metrics which work upon the intermediate results of layout phases. We discuss some properties of the resulting animations by means of examples.",
    ...
    "Hurter2013Bundled": {
        "abstr": "Depicting change captured by dynamic graphs and temporal paths, or trails, is hard. We present two techniques for simplified visualization of such datasets using edge bundles. The first technique uses an efficient image-based bundling method to create smoothly changing bundles from streaming graphs. The second technique adds edge-correspondence data atop of any static bundling algorithm, and is best suited for graph sequences. We show how these techniques can produce simplified visualizations of streaming and sequence graphs. Next, we show how several temporal attributes can be added atop of our dynamic graphs. We illustrate our techniques with datasets from aircraft monitoring, software engineering, and eye-tracking of static and dynamic scenes.",
    ...
    "Kerracher2014Design": {
        "abstr": "This paper presents our work in mapping the design space of techniques for temporal graph visualisation. We identify two independent dimensions upon which the techniques can be classified: graph structural encoding and temporal encoding. Based on these dimensions, we create a matrix into which we organise existing techniques. We identify gaps in this design space which may prove interesting opportunities for the development of novel techniques. We also consider additional dimensions on which further useful classification could be made. In organising the disparate existing approaches from a wide range of domains, our classification will assist those new to the research area, and designers and evaluators developing systems for temporal graph data by raising awareness of the range of possible approaches available, and highlighting possible directions for further research.",
    ...
    "North1996Incremental": {
        "abstr": "Graph drawings are a basic component of user interfaces that display relationships between objects. Generating incrementally stable layouts is important for many applications. This paper describes DynaDAG, a new heuristic for incremental layout of directed acyclic graphs drawn as hierarchies, and its application in the DynaGraph system.",
    ...
    "Saraiya2005Visualization": {
        "abstr": "The most common approach to support analysis of graphs with associated time series data include: overlay of data on graph vertices for one timepoint at a time by manipulating a visual property (e.g. color) of the vertex, along with sliders or some such mechanism to animate the graph for other timepoints. Alternatively, data from all the timepoints can be overlaid simultaneously by embedding small charts into graph vertices. These graph visualizations may also be linked to other visualizations (e.g., parallel co-ordinates) using brushing and linking. This paper describes a study performed to evaluate and rank graph+timeseries visualization options based on users' performance time and accuracy of responses on predefined tasks. The results suggest that overlaying data on graph vertices one timepoint at a time may lead to more accurate performance for tasks involving analysis of a graph at a single timepoint, and comparisons between graph vertices for two distinct timepoints. Overlaying data simultaneously for all the timepoints on graph vertices may lead to more accurate and faster performance for tasks involving searching for outlier vertices displaying different behavior than the rest of the graph vertices for all timepoints. Single views have advantage over multiple views on tasks that require topological information. Also, the number of attributes displayed on nodes has a non trivial influence on accuracy of responses, whereas the number of visualizations affect the performance time.",
